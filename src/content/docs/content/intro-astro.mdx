...
For more on installing `astro` and supporting tooling, see the [astro template](https://github.com/allegheny-college-cmpsc-302-spring-2026/astro-portfolio-starter/fork)
